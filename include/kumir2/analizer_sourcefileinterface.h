...
public:
	...
	// Abstract methods to read and write from/to string
	...
	// Generic methods to read and write from/to raw byte array.
	//	Default implementation assumes UTF-8 encoding with BOM mark,
