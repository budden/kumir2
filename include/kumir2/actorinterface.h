...
public /*methods*/:
	 ...
	 */
	virtual EvaluationStatus evaluate(
		quint32 id, const QVariantList &arguments
	) {
		Q_UNUSED(id);
		Q_UNUSED(arguments);
		return ES_Error;
	...
	virtual class QWidget *mainWidget() { return 0; }

	/** Control window (if exists) */
	virtual class QWidget *pultWidget() { return 0; }
