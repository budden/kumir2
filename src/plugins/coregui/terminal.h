...
public slots:
	...
	QAction *actionSaveAll() const { return a_saveAll; }
	QAction *actionSaveLast() const { return a_saveLast; }
	QAction *actionCopyAll() const { return a_copyAll; }
	QAction *actionCopyLast() const { return a_copyLast; }
	QAction *actionEditLast() const { return a_editLast; }
	QAction *actionClear() const { return a_clear; }
