...
bool PluginManagerImpl::extractRuntimeParametersForPlugin(
	const KPlugin *plugin,
...
void PluginManagerImpl::changeWorkingDirectory(
	const QString &path,
	bool saveChanges,
	bool workDirOnly
) {
...
QString PluginManagerImpl::loadPlugin(
	PluginSpec spec,
	...
	qDebug() << "FileName =  [" << spec.libraryFileName << "] \n";
...
QString PluginManagerImpl::parsePluginsRequest(
	const QByteArray &templ, QList<PluginSpec> &plugins
) {
