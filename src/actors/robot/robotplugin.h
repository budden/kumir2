	...
	public Shared::ActorInterface
{
	...
	Q_PLUGIN_METADATA(IID "kumir2.ActorRobot")
#endif
...
private: /* fields */
	RobotModuleBase* module_;
	RobotAsyncRunThread* asyncRunThread_;
	Widgets::DeclarativeSettingsPage* settingsPage_;
	QString errorText_;
	QVariant result_;
...
class RobotAsyncRunThread : public QThread
{
public: /* methods */
	RobotAsyncRunThread(
		RobotPlugin* plugin,
		RobotModuleBase* module
	);

	// Making protected methods public
	void asleep(unsigned long secs);
	void amsleep(unsigned long msecs);
	void ausleep(unsigned long usecs);
